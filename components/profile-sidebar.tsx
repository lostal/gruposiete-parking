      ...
      >
        <div className="p-6">
          ...
          <div className="flex items-center justify-between mb-6">
            <div>
              <h2 className="text-2xl font-extrabold tracking-tight text-[#343f48]">Mi Perfil</h2>
              <p className="text-sm text-gray-500 mt-1 font-medium">Gestiona tu cuenta</p>
            </div>
            <button
              onClick={onClose}
          ...
          <div className="space-y-6">
            ...
            <div className="bg-white rounded-2xl p-6 brutal-border brutal-shadow">
              <h3 className="text-lg font-extrabold text-[#343f48] mb-4">Cambiar Nombre</h3>
            ...
            <div className="bg-white rounded-2xl p-6 brutal-border brutal-shadow">
              <h3 className="text-lg font-extrabold text-[#343f48] mb-4">Cambiar Contraseña</h3>
            ...
            <div className="bg-white rounded-2xl p-6 brutal-border brutal-shadow border-2 border-red-200">
              <h3 className="text-lg font-extrabold text-red-600 mb-2">Zona de Peligro</h3>
              <p className="text-sm text-gray-600 mb-4 font-medium">{getDeleteWarningMessage()}</p>
